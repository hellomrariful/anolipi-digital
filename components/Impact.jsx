      ...
      <div className="flex justify-center items-center gap-20 mt-5">
        <div className="flex items-center gap-8 justify-center mt-5">
          <div className="flex items-center gap-2">
            <h1 className="text-white text-5xl font-semibold">25<span className="text-secondary font-bold text-5xl">+</span></h1> 
        ...
        <div className="flex items-center gap-8 justify-center mt-5">
          <div className="flex items-center gap-2">
            <h1 className="text-white text-5xl font-semibold">55<span className="text-secondary font-bold text-5xl">+</span></h1> 
            <div className="grid uppercase">
        ...
        <div className="flex items-center gap-8 justify-center mt-5">
          <div className="flex items-center gap-2">
            <h1 className="text-white text-5xl font-semibold">10M<span className="text-secondary font-bold text-5xl">+</span></h1> 
            <div className="grid uppercase">
